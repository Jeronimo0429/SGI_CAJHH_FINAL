                        ...
                        <a class="nav-link" href="{{ url('/home') }}">
                            ...
                            <div class="collapse" id="collapseUser" aria-labelledby="headingOne"
                                ...
                                <nav class="sb-sidenav-menu-nested nav">
                                    <a class="nav-link" href="{{url('usuario')}}"><i class="fas fa-users"></i>&nbsp&nbsp Usuarios</a>
                                </nav>
                            </div>
                            ...
                            <div class="collapse" id="collapseInventory" aria-labelledby="headingOne"
                                data-bs-parent="#sidenavAccordion">
                                <nav class="sb-sidenav-menu-nested nav">
                                    <a class="nav-link" href="{{url('inventario')}}"><i class="fas fa-tags"></i>&nbsp&nbsp Activos</a>
                                </nav>
                            </div>

                            <a class="nav-link collapsed" href="#" data-bs-toggle="collapse"
                                data-bs-target="#collapseInmueble" aria-expanded="false"
                                aria-controls="collapseLayouts">
                                <div class="sb-nav-link-icon"><i class="fas fa-th"></i></div>
                                Gestión de Inmuebles
                                <div class="sb-sidenav-collapse-arrow"><i class="fas fa-angle-down"></i></div>
                            </a>
                            <div class="collapse" id="collapseInmueble" aria-labelledby="headingOne"
                                data-bs-parent="#sidenavAccordion">
                                <nav class="sb-sidenav-menu-nested nav">
                                    <a class="nav-link" href="{{url('mobiliario')}}"><i class="fas fa-tags"></i>&nbsp&nbsp Mobiliario</a>
                                </nav>
                            </div>
                            ...
                            <div class="collapse" id="collapseOrders" aria-labelledby="headingOne"
                                data-bs-parent="#sidenavAccordion">
                                <nav class="sb-sidenav-menu-nested nav">
                                    <a class="nav-link" href="{{url('pedido')}}"><i class="fas fa-cubes"></i>&nbsp&nbsp Pedidos</a>
                            ...
                            <div class="collapse" id="collapseSeason" aria-labelledby="headingOne"
                                data-bs-parent="#sidenavAccordion">
                                <nav class="sb-sidenav-menu-nested nav">
                                    <a class="nav-link" href="{{url('sede')}}"><i class="fas fa-home"></i>&nbsp&nbsp Sedes</a>
